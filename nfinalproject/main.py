...
async def get_stock_data(ticker: str):
    ...
    try:
        ...
        if daily_change_percent != "N/A" and ndaily_change_percent != "N/A" and daily_change_percent >= 0:
            daily_change_percent = " or +" + str(daily_change_percent)
        elif daily_change_percent != "N/A" and ndaily_change_percent != "N/A" and daily_change_percent <= 0:
            daily_change_percent = " or " + str(daily_change_percent) 
        else:
            daily_change_percent = "N/A"
        ...
        data = {
            ...
            "beta": "{:.2f}".format(round_beta) if isinstance(round_beta, (int, float)) else "N/A",
